...
* Refactor to use IMDB::Movie pattern while maintaining backward compatibility with ImdbMovie
...
* Add subclasses for TV Series, TV Episode, and Video Game
* Refactor tests to use local fixtures rather than require teh intarweb (too sloooooow and prone to transient errors)
