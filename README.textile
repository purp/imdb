...
* Move libs into lib directory
* Extend module (attr_accessor_with_default from activesupport) and kernel (silence_warnings from facets)
* Extract attr parsers from initializer and lazy-load instance vars as called
